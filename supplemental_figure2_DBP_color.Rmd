...
tibble::tribble(
  ~Age, ~Cohort,          ~DBP_mean,      ~upperCI,
   ...
   80.1,  "1920-born TUVA cohort",  DBP80_tuva_mean,  DBP80_tuva_upper,
...
# annotate("text", x=70.9, y=90.0, label="1991", color="black", size=4,
#                family = "rosario") +
# annotate("text", x=80.1, y=90.4, label="2000", color="black", size=4,
#                family = "rosario") +
  
annotate("text", x=70.9, y=81.8, label="1991", color="black", size=4,
               family = "rosario") +
annotate("text", x=80.1, y=81.6, label="2000", color="black", size=4,
               family = "rosario") +  

annotate("text", x=85.5, y=96.2, label="2006", color="black", size=4,
               family = "rosario") +
annotate("text", x=89.5, y=91.0, label="2010", color="black", size=4,
               family = "rosario") +
annotate("text", x=94.9, y=80.4, label="2015", color="black", size=4,
               family = "rosario") +

 

annotate("text", x=70, y=99, label="Only participants reaching", color="black", size=4, hjust = 0,
               family = "rosario") +
annotate("text", x=70, y=97, label="95-year-olds' evaluation", color="black", size=4, hjust = 0,
               family = "rosario") +
annotate("text", x=70, y=95, label="in TUVA study (n=55)", color="black", size=4, hjust = 0,
               family = "rosario") +
...
#ggsave("Fig_S2_DBP_dpi600.png", fig2, dpi = 600, bg = "white")
 

# Save as PDF with dpi specified
ggsave("Fig_S2_DBP_dpi600.pdf", fig2, dpi = 600)
